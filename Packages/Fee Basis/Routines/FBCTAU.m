FBCTAU ; GENERATED FROM 'FBAA AUTHORIZATION' INPUT TEMPLATE(#1015), FILE 161;10/01/14
 D DE G BEGIN
...
X1 S FBPRG=""
 Q
2 S D=0 K DE(1) ;1
 S DIFLD=1,DGO="^FBCTAU1",DC="25^161.01ID^1^",DV="161.01DX",DW="0;1",DOW="FROM DATE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
